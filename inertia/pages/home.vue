        ...
        >
            ...
            >
                ...
                <div class="flex flex-row gap-4">
                    <div
                        class="shrink-0 w-10 h-10 bg-primary/20 rounded-md flex justify-center items-center"
                    >
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            Dive into the official documentation to learn AdonisJS. Read carefully
                            to discover an unmatched set of features, best practices and developer
                            experience. Through examples, guides and API references, you'll find
                            everything you need to build your next project. From installation to
            ...
            >
                ...
                <div class="space-y-1">
                    ...
                    <p
                        class="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700"
                    >
                        Level up your development and Adonis skills with hours of video content,
                        from beginner to advanced, through databases, testing, and more.
                    </p>
                </div>
            </article>
            ...
            >
                ...
                <div class="space-y-1">
                    ...
                    <p
                        class="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700"
                    >
                        Supercharge your AdonisJS application with packages built and maintained by
            ...
            >
                ...
                <div class="space-y-1">
                    ...
                    <p
                        class="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700"
                    >
                        Never get lost again, ask questions, and share your knowledge or projects
                        with a growing and supportive community. Join us.
                    </p>
                </div>
            </article>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                >
                    <h2 class="font-semibold text-sand-12">
                        ...
                        >
                            <span
                                class="bg-[#D5EAE7] h-6 w-6 flex justify-center items-center rounded"
                            >
                    ...
                    >
                        A SQL ORM with a powerful query builder, active record, migrations, and
                        model factories. Everything you need to work with databases.
                    </p>
                ...
                >
                    <h2 class="font-semibold text-sand-12">
                        <a href="https://vinejs.dev/" target="_blank" class="flex flex-row gap-2">
                            <span
                                class="bg-[#F3DBFC] h-6 w-6 flex justify-center items-center rounded"
                            >
                    ...
                    <p
                        class="mt-4 text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-100"
                    >
                        A yet simple but feature rich and type-safe form data validation. It comes
                        with 50+ built-in rules and an expressive API to define custom rules.
                    </p>
                ...
                >
                    <h2 class="font-semibold text-sand-12">
                        ...
                        >
                            <span
                                class="bg-[#B8EAE0] h-6 w-6 flex justify-center items-center rounded"
                            >
                    ...
                    <p
                        class="mt-4 text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-100"
                    >
                        The modern monolithic application architecture. It allows you to build
                        single-page applications without building an API.
                    </p>
                ...
                >
                    <h2 class="font-semibold text-sand-12">
                        <a href="https://japa.dev" target="_blank" class="flex flex-row gap-2">
                            <span
                                class="bg-[#FACDDC] h-6 w-6 flex justify-center items-center rounded"
                            >
                    ...
                    <p
                        class="mt-4 text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-100"
                    >
                        From JSON API tests using Open API schema to browser tests with Playwrighht,
                        it comes with everything you need to test your application.
                    </p>
